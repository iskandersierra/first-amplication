...
export class UserControllerBase {
  ...
  async findManyAssignedTasks(
    ...
    const results = await this.service.findAssignedTasks(params.id, {
      ...query,
      select: {
        assignedTo: {
          select: {
  ...
  @common.Delete("/:id/assignedTasks")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  ...
  async findManyOwnedProjects(
    ...
    const results = await this.service.findOwnedProjects(params.id, {
      ...query,
      select: {
        createdAt: true,
        description: true,
  ...
  @common.Post("/:id/ownedProjects")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async createOwnedProjects(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
  ...
  @common.Patch("/:id/ownedProjects")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateOwnedProjects(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/ownedProjects")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
